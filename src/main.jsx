...
import Assignment_45 from "./assignments/Assignment_45.jsx";
import Assignment_46 from "./assignments/Assignment_46.jsx";
import Assignment_47 from "./assignments/Assignment_47.jsx";
import Assignment_48 from "./assignments/Assignment_48.jsx";
  ...
  <StrictMode>
    <HashRouter>
      <Routes>
        ...
        <Route path="/assignment_30" element={<Assignment_30 />} />
        <Route path="/assignment_31" element={<Assignment_31 />} />
        <Route path="/assignment_32" element={<Assignment_32 />} />
        <Route path="/assignment_33" element={<Assignment_33 />} />
        <Route path="/assignment_34" element={<Assignment_34 />} />
        <Route path="/assignment_35" element={<Assignment_35 />} />
        <Route path="/assignment_36" element={<Assignment_36 />} />
        ...
        <Route path="/assignment_41" element={<Assignment_41 />} />
        <Route path="/assignment_42" element={<Assignment_42 />} />
        <Route path="/assignment_43" element={<Assignment_43 />} />
        <Route path="/assignment_44" element={<Assignment_44 />} />
        <Route path="/assignment_45" element={<Assignment_45 />} />
        <Route path="/assignment_46" element={<Assignment_46 />} />
        <Route path="/assignment_47" element={<Assignment_47 />} />
        <Route path="/assignment_48" element={<Assignment_48 />} />
      </Routes>
    </HashRouter>
  </StrictMode>
);
